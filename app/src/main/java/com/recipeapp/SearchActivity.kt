...
class SearchActivity : AppCompatActivity() {
    ...
    private fun searchRecipes() {
        var api_id= "2232b948"
        var api_key="3b11eadc6d914367d4692c2cf86f358e"
        var url = "https://api.edamam.com/search?q=${searchWord}&app_id=${api_id}&app_key=${api_key}&&from=${min}&to=${max}&calories=591-722&health=alcohol-free"
